...
class JSONSchemaToStarrocks(JSONSchemaToSQL):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        if self._max_varchar_length is None:
            raise ValueError("max_varchar_length is required for Starrocks")
...
class StarrocksConnector(SQLConnector):
    ...
    #: TODO: Use the database version to determine if this should be 65533 (<2.1) or 1048576 (>=2.1).
    ...
    def jsonschema_to_sql(self) -> JSONSchemaToStarrocks:
        ...
        return JSONSchemaToStarrocks(max_varchar_length=self.max_varchar_length)
